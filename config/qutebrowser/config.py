...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/martin/.local/share/qutebrowser/userscripts/*')
...
config.bind("<Ctrl-e>", "hint links spawn mpv {hint-url}")
config.bind("<Ctrl-w>", "hint links kitty -e yotutube-dl {hint-url}")
